                    ...
                    <%--分页条信息--%>
                        <div class="col-md-6">
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <li><a href="${APP_PATH}/empSearch?pageNumber=1">首页</a></li>
                                    <c:if test="${pageInfo.hasPreviousPage}">
                                        <li>
                                            <a href="${APP_PATH}/empSearch?pageNumber=${pageInfo.pageNum-1}" aria-label="Previous">
                                    ...
                                    <li><a href="${APP_PATH}/empSearch?pageNumber=${pageInfo.pages}">尾页</a></li>
                                </ul>
                            </nav>
                        </div>
                    <div class="row"></div>
